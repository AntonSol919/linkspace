...
It's primarily meant to read and write arbitrary bytes in some context and quickly beat them into shape.
...
It shows what is required to write a simple app using linkspace.
