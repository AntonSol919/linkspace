...
This is a technical document describing the linkspace protocol, library, and how they fit together.
...
|    32 | hash                |
|   var | point content       |
|  0..7 | \xFF padding bytes  |

Note, the padding bytes are included in the hash.
