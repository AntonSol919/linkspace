...
Linkspace is such a [[https://antonsol919.github.io/linkspace/index.html][supernet]].
...
~python ./examples/mineweeper/mineweeper-hotseat.py~
#+end_verse
...
#+begin_src bash
./emulate/session.tmux.sh bob #changing this name
#+end_src
...
For a game like MineWeeper that is enough.
