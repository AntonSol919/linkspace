...
#+BEGIN_SRC bash :session cli0 :exports both :results output verbatim
  echo -n hello world! | lk datapoint | lk printf
#+END_SRC
...
#+begin_ctabs
#+begin_info
~printf~, and many other functions, take [[../guide/index.html#ABE][ABE]] input. A byte templating language.

src_bash[:exports both]{echo -n "hello" | lk d | lk printf "[hash/?b] => [data]"}

src_bash[:exports both]{echo -n "hello" | lk d | lk printf "[hash/?b/b/?b] => [data/b2]"}
#+end_info
#+end_ctabs
